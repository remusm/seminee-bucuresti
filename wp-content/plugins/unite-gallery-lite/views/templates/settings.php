...
?>
			...
			<div class="ug-button-action-wrapper">
				<a id="ug_button_save_settings" class="unite-button-primary" href="javascript:void(0)"><?php _e("Save Settings", UNITECREATOR_TEXTDOMAIN);?></a>
				
				<div style="padding-top:6px;">
					
					<span id="ug_loader_save" class="loader_text" style="display:none"><?php _e("Saving...", UNITECREATOR_TEXTDOMAIN)?></span>
